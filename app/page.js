  ...
  return (
    <main>
      <div className="py-20 flex flex-col items-center justify-center">
        ...
        <p className="text-center leading-tight mt-2 mx-auto max-w-xs md:max-w-xl text-sm text-gray-600 dark:text-gray-200">Ready-to-use, just copy and paste <span className="opacity-70">className</span> into your code. crafted with <span className="opacity-70">Tailwind CSS</span> tweak it to your taste.</p>
